            ...
            <div className="grid gap-10 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-base leading-8 text-zinc-600">
                  ...
                  creating a startup-led frozen dessert ecosystem where one
                  strong brand can expand into multiple product categories.
                </p>
                <p className="mt-4 text-base leading-8 text-zinc-600">
                  That brand is{" "}
                  <span className="font-semibold text-pink-600">GLAZE</span>. It
                  starts with premium ice cream experiences and grows into
                  candy, choco bars, syrups, donuts, family packs, and many more
                  dessert formats.
                </p>
              </div>
